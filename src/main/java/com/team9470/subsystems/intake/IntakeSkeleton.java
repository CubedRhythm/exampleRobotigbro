...
public class IntakeSkeleton extends SubsystemBase {
    ...
    public IntakeSkeleton() {
        ...
        armMotor = TalonFXFactory.createDefaultTalon(Ports.PIVOT); // Replace with actual initialization
        rollerMotor = TalonFXFactory.createDefaultTalon(Ports.ROLLERS); // Replace with actual initialization
